...
const fixturesAndResultsSchema = new schema.Entity('universalRoundFnR', {
  //idAttribute: round => round.universalRoundOrdinal,
})

const fAndRByCompSchema = new schema.Entity('fAndRByCompId', {
  idAttribute: comp => comp.compId
})
